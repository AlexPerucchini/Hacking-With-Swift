...
//  Gorillas-Project29
//
//  Created by Alex Perucchini on 7/23/19.
...
class GameScene: SKScene, SKPhysicsContactDelegate {
    ...
    override func didMove(to view: SKView) {
        ...
        // need to assign self to be the delegate of your scene's physics world so that you can get notified of collisions.
